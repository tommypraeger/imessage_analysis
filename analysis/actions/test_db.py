...
def main():
    try:
        ...
        ret = add_string_on_new_line(ret, 'Give Terminal (or whatever application you\'re running this from) Full Disk Access')
        ret = add_string_on_new_line(ret, 'More info here: https://spin.atomicobject.com/2020/05/22/search-imessage-sql/')
        return ret
